        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 mt-2">
          <div className="form-control flex flex-col gap-2">
            ...
            <input
              ...
              className={`input input-bordered input-sm w-full focus:border-brand-gold focus:ring-brand-gold ${errors.category ? "input-error" : ""}`}
            />
            {errors.category && (
          ...
          <div className="form-control flex flex-col gap-2">
            ...
            <select
              {...register("type")}
              className={`select select-bordered select-sm w-full focus:border-brand-gold focus:ring-brand-gold ${errors.type ? "select-error" : ""}`}
            >
