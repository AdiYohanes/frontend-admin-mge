...
const ConsoleStats = ({ sharedPeriod }) => {
  ...
  return (
    <div className="card bg-base-100 shadow-md h-full">
      <div className="card-body">
        ...
        <div className="w-full flex items-center justify-center mb-6 min-h-[200px]">
          {chartData.length > 0 ? (
        ...
        {/* Legend Section - Full width below chart */}
              ...
              {chartData.map((item, index) => (
                <div key={index} className="flex items-center gap-3 p-3 bg-base-50 rounded-lg">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-semibold text-base-content text-sm truncate">{item.name}</p>
                    <p className="text-xs text-base-content/60">
                      {item.bookingCount} bookings
                    </p>
                  </div>
                  <div className="text-right flex-shrink-0">
                    <p className="font-bold text-brand-gold text-base">{item.value}%</p>
                  </div>
                </div>
              ))}
            </div>
